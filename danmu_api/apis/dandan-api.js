...
export async function searchAnime(url, preferAnimeId = null, preferSource = null, detailStore = null, targetPlatform = null, options = {}) {
  ...
  if (httpCacheContext.getStore()) {
    return searchAnimeBody(url, preferAnimeId, preferSource, detailStore, targetPlatform, options);
  }
  return runWithHttpCache(() => searchAnimeBody(url, preferAnimeId, preferSource, detailStore, targetPlatform, options));
}

async function searchAnimeBody(url, preferAnimeId = null, preferSource = null, detailStore = null, targetPlatform = null, options = {}) {
